...
const (
	...
	FLAG_ISSUE_METRICS_FILE_DEFAULT = "/var/lib/node_exporter/vault_pki_cli_issue.prom"
	FLAG_ACME_METRICS_FILE_DEFAULT  = "/var/lib/node_exporter/vault_pki_cli_acme.prom"
