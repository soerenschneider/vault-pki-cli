...
const (
	...
	FLAG_VAULT_AUTH_TOKEN                  = "vault-token"
	FLAG_VAULT_AUTH_K8S_ROLE               = "vault-auth-k8s"
	FLAG_VAULT_AUTH_APPROLE_ID             = "vault-role-id"
	FLAG_VAULT_AUTH_APPROLE_SECRET_ID      = "vault-secret-id"
	FLAG_VAULT_AUTH_APPROLE_SECRET_ID_FILE = "vault-secret-id-file"
	FLAG_VAULT_PKI_MOUNT                   = "vault-mount-pki"
	FLAG_VAULT_PKI_BACKEND_ROLE            = "vault-pki-role-name"
	FLAG_VAULT_APPROLE_MOUNT               = "vault-mount-approle"
